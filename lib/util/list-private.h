...
/// @param list List to operate on
/// @param item_size Byte size of each list item
/// @return True if a safe_append or _prepend will work.
...
/// `gv_list_finish_safe_append_` after
...
/// @param item_size Byte size of each list item
/// @return Index of the new (empty) slot
UTIL_API size_t gv_list_safe_append_slot_(list_t_ *list, size_t item_size);
...
/// calling `gv_list_safe_append_slot_`.
///
/// @param list List to operate on
/// @param item_size Byte size of each list item
UTIL_API void gv_list_finish_safe_append_(list_t_ *list);
...
///
/// The caller should should call
/// `gv_list_finish_safe_prepend_` after
/// writing to the returned slot.  The written value will
/// not actually be part of the list without that.
///
/// This function calls `exit` on failure, which
...
/// @param item_size Byte size of each list item
/// @return Index of the new (empty) slot
UTIL_API size_t gv_list_safe_prepend_slot_(list_t_ *list, size_t item_size);

/// Complete a safe prepend by adding the recently
/// added slot to the beginning of the list.  Caller should have
/// written to that slot after obtaining it by
/// calling `gv_list_safe_prepend_slot_`.
///
/// @param list List to operate on
/// @param item_size Byte size of each list item
UTIL_API void gv_list_finish_safe_prepend_(list_t_ *list);
