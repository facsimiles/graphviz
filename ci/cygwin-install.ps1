...
for ($attempt=1; $attempt -le $maxAttempts; $attempt++) {
    ...
    $p = Start-Process "dependencies\cygwin\setup-x86_64.exe" -ArgumentList "--quiet-mode -v --site $mirror --local-package-dir dependencies/cygwin/packages --wait" -Wait -PassThru
